...
#else
#ifdef CONFIG_SKY_SMB_CHARGER
	CLK_8X60("gsbi_qup_clk",	GSBI5_QUP_CLK, "qup_i2c.39", OFF),
#else
	CLK_8X60("gsbi_qup_clk",	GSBI5_QUP_CLK,		NULL, OFF),
#endif
#endif
...
#if defined(CONFIG_PN544)
	CLK_8X60("gsbi_qup_clk",	GSBI10_QUP_CLK,		"qup_i2c.21", OFF),
#else 
...
#else
#ifdef CONFIG_SKY_SMB_CHARGER
	CLK_8X60("gsbi_pclk",		GSBI5_P_CLK, "qup_i2c.39", OFF),
#else
	CLK_8X60("gsbi_pclk",		GSBI5_P_CLK,		NULL, OFF),
#endif
#endif
...
#if defined(CONFIG_PN544)
	CLK_8X60("gsbi_pclk",		GSBI10_P_CLK, "qup_i2c.21", OFF),
#else 
	CLK_8X60("spi_pclk",		GSBI10_P_CLK, "spi_qsd.1", OFF),
#endif
#ifdef CONFIG_SKY_BATTERY_MAX17040 // p14682 kobj 110607ps2 team shs : porting fuel gauge
