...
#if defined(CONFIG_SKY_EF40S_BOARD)
#define MURATA_NV_PATH "/etc/wl/nvram_murata_b2_40s.txt"
#elif defined(CONFIG_SKY_EF40K_BOARD)
#define MURATA_NV_PATH "/etc/wl/nvram_murata_b2_40k.txt"
...
#if defined(DHD_DEBUG) || defined(CONFIG_SKY_EF40S_BOARD) || defined(CONFIG_SKY_EF40K_BOARD)
