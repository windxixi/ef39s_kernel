...
struct s5k4ecgx_i2c_reg_conf
{
	...
	enum s5k4ecgx_width width;
	unsigned short mdelay_time;
};

#define S5K4ECGX_CFG_BRIGHT_MAX_PARAMS 		4
#define S5K4ECGX_CFG_WB_MAX_PARAMS 			12
#define S5K4ECGX_CFG_EFFECT_MAX_PARAMS 		4
#define S5K4ECGX_CFG_EXPOSURE_MAX_PARAMS 		35
#define S5K4ECGX_CFG_PREVIEW_FPS_MAX_PARAMS 	17 //41//28//24
#define S5K4ECGX_CFG_FLICKER_MAX_PARAMS 		5
#define S5K4ECGX_CFG_REFLECT_MAX_PARAMS 		20
#define S5K4ECGX_CFG_FOCUS_STEP_MAX_PARAMS		9


struct s5k4ecgx_reg
{
	/* Init Paramter */
	const struct s5k4ecgx_i2c_reg_conf * init_parm;
	uint16_t init_parm_size;

	const struct s5k4ecgx_i2c_reg_conf *preview_cfg_settings;
	uint16_t preview_cfg_settings_size;
	const struct s5k4ecgx_i2c_reg_conf *snapshot_cfg_settings;
	uint16_t snapshot_cfg_settings_size;

//auto focus command
	const struct s5k4ecgx_i2c_reg_conf *autofocus_cfg_settings;
	uint16_t autofocus_cfg_settings_size;

// inside arm processor go
	const struct s5k4ecgx_i2c_reg_conf *arm_go_cfg_settings;
	uint16_t arm_go_cfg_settings_size;

// S/W standby enter
	const struct s5k4ecgx_i2c_reg_conf *standby_enter_cfg_settings;
	uint16_t standby_enter_cfg_settings_size;

// S/W standby exit
	const struct s5k4ecgx_i2c_reg_conf *standby_exit_cfg_settings;
	uint16_t standby_exit_cfg_settings_size;

//preview frame rate
	const struct s5k4ecgx_i2c_reg_conf (*preview_fps_cfg_settings)[S5K4ECGX_CFG_PREVIEW_FPS_MAX_PARAMS];
	uint16_t preview_fps_cfg_settings_size;

//effect
	const struct s5k4ecgx_i2c_reg_conf (*effect_cfg_settings)[S5K4ECGX_CFG_EFFECT_MAX_PARAMS];
	uint16_t effect_cfg_settings_size;

//wb
	const struct s5k4ecgx_i2c_reg_conf (*wb_cfg_settings)[S5K4ECGX_CFG_WB_MAX_PARAMS];
	uint16_t wb_cfg_settings_size;

//brightness
	const struct s5k4ecgx_i2c_reg_conf (*bright_cfg_settings)[S5K4ECGX_CFG_BRIGHT_MAX_PARAMS];
	uint16_t bright_cfg_settings_size;

//exposure
	const struct s5k4ecgx_i2c_reg_conf (*exposure_cfg_settings)[S5K4ECGX_CFG_EXPOSURE_MAX_PARAMS];
	uint16_t exposure_cfg_settings_size;

//flicker
	const struct s5k4ecgx_i2c_reg_conf (*flicker_cfg_settings)[S5K4ECGX_CFG_FLICKER_MAX_PARAMS];
	uint16_t flicker_cfg_settings_size;

//flicker
	const struct s5k4ecgx_i2c_reg_conf (*reflect_cfg_settings)[S5K4ECGX_CFG_REFLECT_MAX_PARAMS];
	uint16_t reflect_cfg_settings_size;

//foucs mode
	const struct s5k4ecgx_i2c_reg_conf (*focus_step_cfg_settings)[S5K4ECGX_CFG_FOCUS_STEP_MAX_PARAMS];
