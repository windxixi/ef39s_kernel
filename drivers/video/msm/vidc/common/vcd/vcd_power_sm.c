     ...
     struct vcd_property_frame_rate *fps, u32 frm_p_units)
{
	...
	u32 new_perf_lvl;
       ...
       #if (0) // FEATURE_PANTECH_MMP_QCOM_CR CASE#00640741
	new_perf_lvl =
       ...
       /*VCD_MSG_HIGH*/printk(KERN_INFO " \n[PANTECH] new_perf_lvl(%u), frm_p_units(%u), fps_numerator(%u), fps_denominator(%d) In vcd_update_clnt_perf_lvl()"
