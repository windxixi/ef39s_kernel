...
static struct mpu3050_platform_data mpu3050_data = {
    .int_config = 0x10,
    /* top-lower-left */
#if defined(CONFIG_EF39S_SENSORS_MPU3050) 
	 .orientation = { 0, 1, 0,
        -1, 0, 0,
        0, 0, 1
    },
#elif defined(CONFIG_EF40S_SENSORS_MPU3050) 
	 .orientation = { -1, 0, 0,
        0, -1, 0,
        0, 0, 1
    },
...
#elif defined(CONFIG_EF40S_SENSORS_BMA150)
    .accel = {
        .get_slave_descr = bma150_get_slave_descr,
...
#elif defined(CONFIG_EF40S_SENSORS_BMA250)
    .accel = {
        .get_slave_descr = bma250_get_slave_descr,
#if (defined(CONFIG_MACH_MSM8X60_EF40S) && (BOARD_REV >= WS20))
        .adapt_num = 33, //MSM_GSBI5_QUP_I2C_BUS_ID, // The i2c bus to which the mpu device is
...
#if defined(CONFIG_EF39S_SENSORS_YAS530) || defined(CONFIG_EF40K_SENSORS_YAS530) || defined(CONFIG_EF40S_SENSORS_YAS530)
    .compass = {
